...
if (selected == 'Diabetes Prediction'):
    ...
    with col1:
         BMI = st.number_input('BMI value', min_value=0.0, max_value=50.0, format='%0.1f')

    with col2:
         DiabetesPedigreeFunction = st.number_input('Diabetes Pedigree Function value', min_value=0.000, max_value=3.000, format='%0.3f')
